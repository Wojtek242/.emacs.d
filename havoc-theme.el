;;; havoc-theme.el --- Havoc - A custom theme for Emacs
;;
...
(defgroup havoc-theme nil
  "havoc-theme options."
  :group 'faces)

(defcustom havoc-theme-comment-bg t
  "Use a background for comment lines."
  :type 'boolean
  :group 'havoc-theme)

(defcustom havoc-theme-org-agenda-height t
  "Use varying text heights for org agenda."
  :type 'boolean
  :group 'havoc-theme)

(defcustom havoc-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'havoc-theme)

(defcustom havoc-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'havoc-theme)

(defcustom havoc-theme-custom-colors nil
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,comment :background ,(when havoc-theme-comment-bg comment-bg)))))
...
;;;;; latex
     ...
     `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,head3 :height ,(if havoc-theme-org-height 1.3 1.0) :background ,(when havoc-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,head4 :height ,(if havoc-theme-org-height 1.3 1.0) :background ,(when havoc-theme-org-highlight head4-bg)))))
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :height ,(if havoc-theme-org-height 1.3 1.0) :background ,(when havoc-theme-org-highlight head1-bg)))))
     `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :height ,(if havoc-theme-org-height 1.2 1.0) :background ,(when havoc-theme-org-highlight head2-bg)))))
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :height ,(if havoc-theme-org-height 1.1 1.0) :background ,(when havoc-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,head4 :background ,(when havoc-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :height ,(if havoc-theme-org-height 1.3 1.0) :background ,(when havoc-theme-org-highlight head1-bg)))))
     `(markdown-header-face-2 ((,class (:inherit bold :foreground ,head2 :height ,(if havoc-theme-org-height 1.2 1.0) :background ,(when havoc-theme-org-highlight head2-bg)))))
     `(markdown-header-face-3 ((,class (:bold nil :foreground ,head3 :height ,(if havoc-theme-org-height 1.1 1.0) :background ,(when havoc-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:bold nil :foreground ,head4 :background ,(when havoc-theme-org-highlight head4-bg)))))
...
;;;;; org
     ...
     `(org-agenda-date ((,class (:foreground ,var :height ,(if havoc-theme-org-agenda-height 1.1 1.0)))))
     `(org-agenda-date-today ((,class (:foreground ,keyword :inherit bold :height ,(if havoc-theme-org-agenda-height 1.3 1.0)))))
     `(org-agenda-date-weekend ((,class (:inherit bold :foreground ,var))))
     `(org-agenda-done ((,class (:foreground ,suc :height ,(if havoc-theme-org-agenda-height 1.2 1.0)))))
     ...
     `(org-document-title ((,class (:foreground ,func :inherit bold :height ,(if havoc-theme-org-height 1.4 1.0) :underline t))))
     ...
     `(org-level-1 ((,class (:inherit bold :foreground ,head1 :height ,(if havoc-theme-org-height 1.3 1.0) :background ,(when havoc-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :foreground ,head2 :height ,(if havoc-theme-org-height 1.2 1.0) :background ,(when havoc-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,head3 :height ,(if havoc-theme-org-height 1.1 1.0) :background ,(when havoc-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,head4 :background ,(when havoc-theme-org-highlight head4-bg)))))
     ...
     `(org-scheduled-today ((,class (:foreground ,func :height ,(if havoc-theme-org-agenda-height 1.2 1.0)))))
